# Permitting & Licensing Journey Viz
...
**115 journeys** | **59 PLC types** | **15 categories** | **3 jurisdiction levels**
...
- Hit **Auto-Play** to cycle through all 115 journeys automatically
- Hit **Show Network** to see all 59 permit types at once, sized by how many journeys use them
...
plcNodes       — 59 permit/license/compliance node types
journeys       — 115 journeys, each an ordered list of node IDs
```
...
| [DATA_COLLECTION.md](DATA_COLLECTION.md) | How the 115 journeys were researched |
